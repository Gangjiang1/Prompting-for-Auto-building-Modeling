...
# Task 1, one-shot 
real_one_shot_completion = client.chat.completions.create(
    model=model,
    messages=real_one_shot
)
print(">>>>>>>>>>>>>>real_one_shot>>>>>>>>>>>>>>>>>")
print(real_one_shot_completion.choices[0].message)



# Task 1, two-shot 
real_two_shot_completion = client.chat.completions.create(
    model=model,
    messages=real_two_shot
)
print(">>>>>>>>>>>>>>real_two_shot>>>>>>>>>>>>>>>>>")
print(real_two_shot_completion.choices[0].message)



# Task 1, three-shot 
real_three_shot_completion = client.chat.completions.create(
    model=model,
    messages=real_three_shot
)
print(">>>>>>>>>>>>>>real_three_shot>>>>>>>>>>>>>>>>>")
print(real_three_shot_completion.choices[0].message)



# Task 1, explain
real_explanation_completion = client.chat.completions.create(
    model=model,
    messages=real_explanation
)
print(">>>>>>>>>>>>>>real_explain>>>>>>>>>>>>>>>>>")
print(real_explanation_completion.choices[0].message)



# Task 1, division
real_division_completion = client.chat.completions.create(
    model=model,
    messages=real_division
)
print(">>>>>>>>>>>>>>real_division>>>>>>>>>>>>>>>>>")
print(real_division_completion.choices[0].message)