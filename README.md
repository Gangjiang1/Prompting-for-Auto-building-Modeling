...
- Real-World Task:
Task 3: Produces a detailed model for a real-world modular test facility (iUnit) at NREL, supporting customizable materials, occupancy schedules, HVAC, and energy settings (~5k tokens).
